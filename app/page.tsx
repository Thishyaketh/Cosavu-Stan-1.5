...
const defaultPrompt =
  "Hey so I am trying to understand how to design a production-grade retrieval augmented generation system, but I keep mixing together questions about chunking, embeddings, reranking, latency, cost, and what the model should actually see, so can you please explain the tradeoffs in a clear way and include a compact markdown table?";
...
function MetricTable({ result, cosavu }: { result?: CompareResult["raw"]; cosavu?: CompareResult["cosavu"] }) {
  const rows = [
    ...
    ["Chat output", tokenText(result?.usage.outputTokens)],
